...
---
### Summary
A linear regression model was used to describe the percentage of female crew member participation through time by film department (directing, writing, and production), as well as the combination of those three target departments. Those specific departments were chosen due to their influence in the movie-making process *(those who wrote the stories, those who made the stories into a reality, and those who made sure the stories were able to be heard)*.
